...
: "${EVALUATION_MODEL_PATH:?Set EVALUATION_MODEL_PATH to the local Qwen3.8-27B directory}"
VLLM_BIN="${VLLM_BIN:-vllm}"
CACHE_ROOT="${DRAMA_CACHE_ROOT:-$PWD/cache/qwen38}"
